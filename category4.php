				...
				<div class="col-lg-3 order-2 order-lg-1">
					<div class="filter-widget">
						...
						<ul class="category-menu">
							...
							<li><a href="./category1.php">All tables </a>
								<ul class="sub-menu">
									<li><a href="./category2.php">Short <span> </span></a></li>
									<li><a href="./category3.php">Max Tables <span> </span></a></li>
									<li><a href="./category4.php">Modern<span>  </span></a></li>
								</ul></li>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img <?php echo "src=$product->image" ; ?>>
									<div class="pi-links">
										<a href="cart.php?id= <?php echo $product->id; ?> &action=add" class="add-card" target="_blank"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
